...
const routes: Routes = [
  ...
  { path: 'discover/tv-shows', component: DiscoverTvShowsComponent },
  ...
  { path: 'tv-shows/airing-today', component: TvShowsAiringTodayComponent },
  { path: 'tv-shows/on-tv', component: TvShowsOnTvComponent },
  { path: 'tv-shows/popular', component: TvShowsPopularComponent },
  { path: 'tv-shows/top-rated', component: TvShowsTopRatedComponent },
